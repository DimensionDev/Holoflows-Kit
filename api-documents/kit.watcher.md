...
|  [firstDOMProxy](./kit.watcher.firstdomproxy.md) | <code>readonly</code> | T extends Node ? [DOMProxy](./kit.domproxy.md)<!-- -->&lt;T, Before, After&gt; : never | <p>This DOMProxy always point to the first node in the LiveSelector</p><p>! Call .destroy on firstDOMProxy cause undefined behavior</p> |
